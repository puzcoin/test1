...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 1750; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nMasternodePaymentsIncreaseBlock = 1750; // actual historical value
...
*/
            ( 174, uint256S("0x0000018e50574080306a385a7dd8e1aef8d47d5aeb4868306287b12564f068ad")),
