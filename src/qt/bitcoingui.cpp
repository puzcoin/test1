    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Puzcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Puzcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and puzcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Puzcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Puzcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Puzcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Puzcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Puzcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a puzcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Puzcoin Core help message to get a list with possible Puzcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Puzcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Puzcoin network", "", count));
}
...
{
    QString strTitle = tr("Puzcoin Core"); // default title
